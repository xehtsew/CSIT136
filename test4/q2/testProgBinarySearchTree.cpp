...
int main() {
	...
	cout << endl << endl << "I'm going to try to add 3 to your tree:" << endl;
	//displays error
	tree.insert(3);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	cout << endl << endl << "*******************Swapping subtrees" << endl;
	tree.swapSubTrees();
	cout << "*****************Printing swapped tree" << endl;
	tree.inorderTraversal();
	//////////////////////////////////////////////////////////////////////////////////////////////
	cout << endl << endl << "display the nodes again.. without 3!" << endl;
	tree.inorderTraversal();

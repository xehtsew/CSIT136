...
private:
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	void binaryTreeType<elemType>::swapNode(binaryTreeNode<elemType> *p);
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void postorder(binaryTreeNode<elemType> *p) const;
      ...
      //tree to which p points.  
	vector<int>inorderVectorPrivate(binaryTreeNode<elemType> *p, vector<int> &dataVector) const;
...
template <class elemType>
void binaryTreeType<elemType>::inorderVectorTraversal() {
	inorderVectorPrivate(root, dataVector);
}
template <class elemType>
...
template <class elemType>
void binaryTreeType<elemType>::swapNode(binaryTreeNode<elemType> *p) {
	binaryTreeNode<elemType> *temp = NULL;
	if (p != NULL) {
		swapNode(p->llink);
		swapNode(p->rlink);
		temp = p->llink;
...
template <class elemType>
vector<int> binaryTreeType<elemType>::inorderVectorPrivate(binaryTreeNode<elemType> *p, vector<int> &dataVector) const {
	if (p != NULL)
	{
		inorderVectorPrivate(p->llink, dataVector);
		dataVector.push_back(p->info);
		inorderVectorPrivate(p->rlink, dataVector);
	}
	return dataVector;
}

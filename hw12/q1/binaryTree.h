...
template <class elemType>
void binaryTreeType<elemType>::inorderNonrecursive() {
	stack<binaryTreeNode<elemType> *>nodeStack;
	binaryTreeNode<elemType> *current;
	current = root;
	while ((current != NULL) || nodeStack.empty() != true) {
		if (current != NULL) {
...
template <class elemType>
void binaryTreeType<elemType>::preorderNonrecursive() {
	stack<binaryTreeNode<elemType> *>nodeStack;
	binaryTreeNode<elemType> *current;
	current = root;
	while ((current != NULL) || nodeStack.empty() != true) {
...
template <class elemType>
void binaryTreeType<elemType>::postorderNonrecursive() {
